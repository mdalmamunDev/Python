...
def text_to_speech(text, audio_path, lang="en"):
...
def create_video(image_path, text, video_path, duration, font="NotoSansBengali-Regular.ttf"):
    ...
    for sentence in sentences:
        ...
        filter_complex += f"drawtext=text='{wrapped_text}':fontfile={font}:fontcolor=white:fontsize=24:x=(w-text_w)/2:y=h-50:enable='between(t,{start_time},{end_time})', "
...
# Input Data
text_bangla = "এটি একটি বাংলা ভিডিও। এটি এ.আই. দ্বারা তৈরি হয়েছে। আপনি এখানে বাংলা ভাষায় ভিডিও দেখছেন।"
image_path = "image.jpg"  # Replace with your image file
audio_path = "audio_bangla.mp3"
video_path = "silent_video_bangla.mp4"
output_path = "output_bangla.mp4"

# Step 1: Convert text to speech (Bangla)
...
# Step 3: Create a silent video with all sentences (Bangla)
create_video(image_path, text_bangla, video_path, duration, font="NotoSansBengali-Regular.ttf")

# Step 4: Merge the silent video with the generated audio
merge_audio_video(video_path, audio_path, output_path)

print("Bangla video created successfully!")
